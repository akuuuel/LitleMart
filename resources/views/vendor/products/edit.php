        ...
        <main class="flex-1 overflow-y-auto p-6">
            <div class="max-w-3xl mx-auto">
                <div class="mb-6">
                    ...
                    <h2 class="text-xl font-black text-gray-900">Edit Produk</h2>
                    <p class="text-xs text-gray-500 mt-0.5">Ubah detail daftar marketplace Anda.</p>
                </div>

                <form action="<?= url('/vendor/products/update/' . $product['id']) ?>" method="POST" enctype="multipart/form-data" class="space-y-5">
                    <!-- Basic Info -->
                    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="brand" placeholder="misal: Sony, IKEA" value="<?= htmlspecialchars($product['brand'] ?? '') ?>"
                            ...
                            <div>
                                ...
                                <div class="flex gap-4">
                                    <label class="flex-1 cursor-pointer group">
                                        <input type="radio" name="condition" value="new" <?= ($product['condition'] ?? 'new') === 'new' ? 'checked' : '' ?> class="hidden peer">
                                    ...
                                    <label class="flex-1 cursor-pointer group">
                                        <input type="radio" name="condition" value="used" <?= ($product['condition'] ?? '') === 'used' ? 'checked' : '' ?> class="hidden peer">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="4" required
                                class="w-full px-4 py-2.5 border border-gray-200 bg-white rounded-xl text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#056526]/20 focus:border-[#056526] resize-none"><?= htmlspecialchars($product['description']) ?></textarea>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="price" required min="0" value="<?= (int)$product['price'] ?>"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="weight" required min="0" value="<?= (int)$product['weight'] ?>"
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-4">
                        ...
                        <div class="border-2 border-dashed border-gray-200 rounded-xl p-6 text-center hover:border-[#056526] transition-colors cursor-pointer" onclick="document.getElementById('images').click()">
                            ...
                            <p class="text-sm font-semibold text-gray-600">Klik untuk ganti foto</p>
                            <p class="text-[10px] text-gray-400 mt-1 uppercase font-black tracking-widest">Opsional - mengunggah foto baru akan menggantikan yang lama</p>
                        </div>
                        
                        <div id="preview" class="grid grid-cols-4 gap-3 mt-2">
                            <?php if (!empty($product['primary_image'])): ?>
                                <div class="aspect-square rounded-xl overflow-hidden border border-gray-100 shadow-sm relative group">
                                    <img src="<?= url($product['primary_image']) ?>" class="w-full h-full object-cover">
                                    <div class="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                        <span class="text-[8px] text-white font-black uppercase tracking-widest">Saat Ini</span>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
